$(document).ready(function() {
    ...
    createMultiChart('column', ['Public', 'Private'], null, {
        ...
        2020: ['data/2020/2/0/public_cheating.csv', 'data/2019/2/0/private_cheating.csv']
    ...
    createChart('column',{
        ...
        2020: 'data/2020/2/0/cheating_by_recruit.csv'
    ...
    createMultiChart('column', {
        ...
        2020: ['On an exam', 'On a paper or homework']
    }, null, {
        ...
        2020: ['data/2020/2/0/gender_cheaters_exam.csv', 'data/2020/2/0/gender_cheaters_papers.csv']
    ...
    createMultiChart('column', ['Non-recruited', 'Recruited'], null, {
        ...
        2020: ['data/2020/2/0/not_recruited_cheaters.csv', 'data/2020/2/0/recruited_cheaters.csv']
    ...
    createMultiChart('column', ['All', 'Only athletes'], ["#8bbc21", "#0d233a"], {
        ...
        2020: ['data/2020/2/1/hours_studying_past_all.csv', 'data/2020/2/1/hours_studying_past_athletes_empty.csv']
    }, '#study-habits-past', null, /* override */ { yAxis: { max: 35 } });
    createMultiChart('column', ['Public', 'Private'], null, {
        2019: ['data/2019/2/1/public_hours.csv', 'data/2019/2/1/private_hours.csv'],
        2020: ['data/2020/2/1/public_hours.csv', 'data/2020/2/1/private_hours.csv']
    ...
    createMultiChart('column', ['All', 'Public', 'Private'], null, {
        ...
        2020: ['data/2020/2/1/math_level.csv', 'data/2020/2/1/public_vs_math.csv', 'data/2020/2/1/private_vs_math.csv']
    }, '#math-level');
    createChart('pie',{
        ...
        2020: 'data/2020/2/1/sources_of_pressure.csv'
    }, '#pressure');
    createChart('bar',{
        2018: 'data/2018/2/1/athletics_by_income.csv',
        2019: 'data/2019/2/1/athletics_by_income.csv',
        2020: 'data/2020/2/1/athletics_by_income.csv'
    ...
    createChart('bar',{
        ...
        2020: 'data/2020/2/1/government_belief.csv'
    }, '#government');
    ...
    createChart('pie',{
        ...
        2020: 'data/2020/2/2/hours_studying_future.csv'
    }, '#study-habits-future');
    createMultiChart('bar', ['Academics', 'Extracurriculars', 'Social Life', 'Paid Employment', 'Varsity Sports'], 
        ...
        2020: ['data/2020/2/2/priorities_academics.csv', 'data/2020/2/2/priorities_extracurriculars.csv', 'data/2020/2/2/priorities_social.csv', 'data/2020/2/2/priorities_job.csv', 'data/2020/2/2/priorities_sports.csv']
    ...
    createMultiChart('column', ['Public', 'Private'],
        ...
        2020: ['data/2020/2/2/greek_public.csv', 'data/2020/2/2/greek_private.csv']
    ...
    createMultiChart('column', ['Recruits', 'Walk-ons'], ["#77a1e5", "#f28f43"], {
        ...
        2020: ['data/2020/2/3/four_years_recruit.csv', 'data/2020/2/3/four_years_walk.csv']
    }, '#attrition-athletics', null, /* override */ { yAxis: { max: 100 } });
    createChart('column',{
        2017: 'data/2017/2/3/concussions.csv',
        2018: 'data/2018/2/3/concussions.csv',
        2019: 'data/2019/2/3/concussions.csv',
        2020: 'data/2020/2/3/concussions.csv'
    }, '#concussions');
    ...
    createChart('column',{
        ...
        2020: 'data/2020/2/3/economics_conc_by_athletics.csv'
